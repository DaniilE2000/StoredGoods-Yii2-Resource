...
<section class="common-box table-col-controls-box">
    ...
    <ul class="table-col-controls">
        <li>Изображение<input type="checkbox" id="toggler-image" autocomplete="off" checked></li>
        <li>Идент. номер<input type="checkbox" id="toggler-sku" autocomplete="off" checked></li>
        <li>Название<input type="checkbox" id="toggler-title" autocomplete="off" checked></li>
        <li>Кол-во<input type="checkbox" id="toggler-amount" autocomplete="off" checked></li>
        <li>Тип товара<input type="checkbox" id="toggler-type" autocomplete="off" checked></li>
    </ul>
</section>
        ...
        <caption>
            Список товаров <div class="searchbox">
                <form method="get" action="<?= \yii\helpers\Url::to(['site/search']); ?>">
                    <input type="text" name="q" id="search" placeholder="SKU или Название">
